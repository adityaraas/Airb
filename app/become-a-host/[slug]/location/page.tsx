   ...
   // const MapComponent=React.lazy(()=>import('@/app/components/Map'))
    ...
    return (
      ...
      <div className="fixed w-full border-solid border-t-4 p-6 bottom-0">
              ...
              <button onClick={()=>router.push(`/become-a-host/${uniqidid}/floor-plan`)} className="p-3 bg-gradient-to-tr text-white  from-pink-600 via-pink-700 to-pink-800 float-right font-bold ml-auto">Next</button>
            </div>
